<?php defined('ROOT_PATH') OR exit("You don't have permission to access this resource."); ?>
        ...
        <section>
            <h2>Conclusion :</h2>
            <p>En utilisant notre site, vous acceptez l'utilisation des cookies telle que décrite dans notre politique de cookies.</p>
        </section></br>

        <p>Retour aux <a href="<?=BASE_URL?>mentions">mentions légales</a>.</p>    
