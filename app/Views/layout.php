...
//header("Content-Security-Policy: default-src 'self' ".BASE_URL."; script-src 'self' ".BASE_URL."; style-src 'self' ".BASE_URL); // Vs XSS. Only scripts from same domain (default;js;css).
