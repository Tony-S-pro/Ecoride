...
//header("Content-Security-Policy: default-src 'self'; script-src 'self' 'unsafe-inline' ; style-src 'self' 'unsafe-inline' ; img-src 'self' ".BASE_URL); // Vs XSS. Only scripts from same domain (default;js;css;img). Désactivé a cause des icons bootstrap.
